...
public static class SpacingConstants
{
    ...
    /// </summary>
    public static float HSPACE_SMALL => 315f * Camera.main.aspect;

    /// <summary>
    /// About 1/3 the screen's width, making it good for 3-column setups.
    /// </summary>
    public static float HSPACE_MEDIUM => 420f * Camera.main.aspect;

    /// <summary>
    /// About 1/2 the screen's width, making it good for 2-column setups.
    /// </summary>
    public static float HSPACE_LARGE => 630f * Camera.main.aspect;
