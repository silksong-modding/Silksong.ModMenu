...
public class ScrollingMenuScreen(LocalizedText title)
    : BasicMenuScreen(title, new ScrollingPane(new VerticalGroup()))
{
    /// <summary>
    /// The scrolling viewport for this menu screen.
    /// </summary>
    public ScrollingPane ScrollPane => (ScrollingPane)base.Content;

    /// <inheritdoc cref="BasicMenuScreen.Content"/>
    public new VerticalGroup Content => (VerticalGroup)ScrollPane.Content!;
